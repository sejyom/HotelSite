	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (userid.equals("akxxkd")) {
				request.getRequestDispatcher("index.jsp?addr=managerPage.jsp&cont=reserlist.jsp").forward(request, response);
			} else {
				request.getRequestDispatcher("index.jsp?addr=myPage.jsp&cont=reserlist.jsp").forward(request, response);
			}
