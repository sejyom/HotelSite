...
<div class="roomIntro">	
	<div class="view">		
		...
		<p class="room_name">MOUNTAIN, STANDARD ROOM</p><br>
	 	<p class="room_text">
	...
	<div class="view">		
		...
		<p class="room_name">MOUNTAIN, SWEET ROOM</p><br>
	 	<p class="room_text">
	...
	<div class="view">		
		...
		<p class="room_name">CITY, STANDARD ROOM</p><br>
	 	<p class="room_text">
	...
	<div class="view">		
		...
		<p class="room_name">CITY, SWEET ROOM</p><br>
	 	<p class="room_text">
	...
	<div class="view">		
		...
		<p class="room_name">HANRIVER, STANDARD ROOM</p><br>
	 	<p class="room_text">
	...
	<div class="view">		
		...
		<p class="room_name">HANRIVER, SWEET ROOM</p><br>
	 	<p class="room_text">
